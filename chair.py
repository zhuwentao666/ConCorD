"""We refer to Deco to implement CHAIR metric, which is used to evaluate hallucination in captions."""
...
if __name__ == '__main__':
    ...
    parser.add_argument("--cache", type=str, default="chair_cache.pkl",
